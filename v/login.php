...
<html lang="en">
    ...
    <br><br>
    <header style="height: 100%; background-color: dimgrey;">
...
<br>
        Vous n'avez pas encore un Compte ? <a style="font-size: 20px;" href="sign-up.php">Incrivez-Vous ICI</a><br><br>

        <a style="font-size: 20px;" href="sign-up.php">Mot de Passe Oublié ?</a>
    </div>
